 ...
 * Date: 2017/11/17
 * Time: 13:49
 * Func:二期合同（English合同） (25)
 */
namespace app\index\controller;

use think\Db;

class ContractE extends Common
{
    function initialize()
    {
        parent::initialize();
    ...
    * */
    public function update()
    {
        if (request()->isPost()) {
            ...
            if ($map['tasktype'] == 1) {
                ...
                $resultData = Db::table('Z_TB_FlowApp_EContractApplication')->where('ID=' . $map['ID'])->find();
    ...
    {
        $result = Db::table('Z_TB_FlowApp_EContractOrderInfo')
