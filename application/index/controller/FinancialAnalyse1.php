...
class FinancialAnalyse1 extends Common
{
    ...
    public function initialize()
    {
        ...
        $this->table = Db::table('Z_TB_Financial_Analyse');
    }
    ...
    public function save()
    {
        ...
        //注册信息
        $map['analyse'] = input('request.analyse');
	...
	public function saveEng(){
		...
		$map['analyseEng']=input('request.analyseEng');
