 ...
 * User: Robin
 * Date: 2017/11/14
 * Func: 青岛免费/非免费落货纸审批(24,31) 顺德免费/非免费落货纸审批(30,32)
 */
namespace app\index\controller;

use think\Db;

class LhzQm extends Common
{
    function initialize()
    {
        parent::initialize();
   ...
   * */
    public function update()
    {
        if (request()->isPost()) {
            ...
            if ($map['tasktype'] == 1) {
                ...
                $resultData = Db::table('Z_TB_FlowApp_LHZApplication')->where('ID=' . $map['ID'])->find();
    ...
    {
        $result = Db::table('Z_TB_FlowApp_LHZContractInfo')
